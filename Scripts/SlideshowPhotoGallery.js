...
var slideShowClass = {
    ...
    // element that holds the selected index content
	...
	CalcMaxIndex: function (photoCount) {
	    if (this.currentContentIndex <= 3) {
	        return 6;
	    }
	    else if ((photoCount - this.currentContentIndex) <= 3) {
	        return photoCount - 1;
	    }
	    else {
	        return this.currentContentIndex + 3;
	    }
	},
	CalcMinIndex: function (photoCount) {
	    if (this.currentContentIndex <= 3) {
	        return 0;
	    }
	    else if ((photoCount - this.currentContentIndex) <= 3) {
	...
	MoveToSlide: function(slideshow, index) {
	    if (!this.transitioning && slideshow.currentContentIndex !== index) {
	        slideshow.currentContentIndex = index;
	        slideshow.PerformTransition('selected');
	    }
	},
